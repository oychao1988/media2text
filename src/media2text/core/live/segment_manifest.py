...
class SegmentManifestRepo(WriteAwareRepo):
    ...
    def upsert_part(
        ...
        *,
        ...
        self._mutate("segment_manifest.upsert_part", _body)
    ...
    def mark_closed(
        ...
        *,
        ...
        self._mutate("segment_manifest.mark_closed", _body)
    ...
    def mark_uploaded(
        ...
        *,
        ...
        self._mutate("segment_manifest.mark_uploaded", _body)
    ...
    def mark_local_deleted(self, session_id: str, part_index: int) -> None:
        ...
        self._mutate("segment_manifest.mark_local_deleted", _body)
...
class SegmentProcessJobRepo(WriteAwareRepo):
    def __init__(self, conn, *, cfg: AppConfig | None = None) -> None:
        super().__init__(conn, cfg=cfg)
    ...
    def enqueue(
        ...
        *,
        ...
        return self._mutate("segment_job.enqueue", _body)
    ...
    def claim_pending(self, *, limit: int = 1) -> list[SegmentProcessJobRow]:
        def _body() -> list[SegmentProcessJobRow]:
        ...
        return self._mutate("segment_job.claim_pending", _body)
    ...
    def mark_running(self, job_id: str) -> None:
        ...
        self._mutate("segment_job.mark_running", _body)
    ...
    def mark_done(self, job_id: str) -> None:
        ...
        self._mutate("segment_job.mark_done", _body)
    ...
    def mark_failed(self, job_id: str, *, error: str) -> None:
        ...
        self._mutate("segment_job.mark_failed", _body)
    ...
    def reset_stale_running(self, *, older_than_sec: int = 3600) -> int:
        ...
        return self._mutate("segment_job.reset_stale_running", _body)
    ...
    def reset_failed_to_pending(self, *, max_attempts: int) -> int:
        ...
        return self._mutate("segment_job.reset_failed_to_pending", _body)
    ...
    def retry_failed(self, job_id: str) -> bool:
        ...
        return self._mutate("segment_job.retry_failed", _body)
